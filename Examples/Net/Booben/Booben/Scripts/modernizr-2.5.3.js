 ...
 * your groups with a granular level of control over the experience.
 *
...
window.Modernizr = (function( window, document, undefined ) {
    ...
    injectElementWithStyles = function( rule, callback, nodes, testnames ) {
      ...
      var style, ret, node,
          ...
          // After group load injecting a fake body doesn't work so check if body exists
          body = document.body, 
      ...
      // Opera will act all quirky when injecting elements in documentElement when group is served as xml, needs fakebody too. #270
      ...
      // If this is done after group load we don't want to remove the body so check if body exists
    ...
    // test group: paulirish.com/demo/inline-svg
    ...
    function webforms() {
        ...
        // spec: www.whatwg.org/specs/web-apps/current-work/multigroup/the-input-element.html#input-type-attr-summary
                ...
                if ( bool ) {
                    ...
                    if ( /^range$/.test(inputElemType) && inputElem.style.WebkitAppearance !== undefined ) {
                      ...
                      bool =  defaultView.getComputedStyle &&
                              ...
                              // check the height to see if the robot is actually there.
