...
void BigDoc::procAlias(char* json,
						char* key,
						uint32 currPos,
						uint32* arrayPos,
						uint32** arrayMaxPos,
...
uint32 BigDoc::setPathIndexes(uint32* arrayPos,
								uint32* indexes,
								char* key,
								uint32 level,
								uint32& currPos)
...
ValueList* BigDoc::getDocsByAttr(char* json,
									uint32 docID ,
									uint32 tranID,
									uint32 collID,
...
uint32 BigDoc::getPartDoc(char* jsonTemplate,
						  char* jsonResult,
...
uint32 BigDoc::addDocFromFile(char* fileName)
{
...
uint32 BigDoc::insPartDoc(char* json,
						  uint32 docID,
						  uint32 tranID,
						  uint32 collID,
						  uint32* indexes)
...
uint32 BigDoc::updPartDoc(char* json,
						uint32 docID,
						uint32 tranID,
						uint32 collID,
						uint32* indexes,
